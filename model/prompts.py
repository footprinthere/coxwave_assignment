...
* If you cannot answer the question, just generate an appropriate message.
* For questions that are unrelated to "스마트스토어", generate a message that you cannot answer them.
...
[Your Answer]
죄송합니다. 저는 스마트스토어에 관한 질문에만 대답할 수 있습니다.
